...
namespace SAP_API
{
  public class MyGuiModalWindow
  {
    public interface ISapModalWindowTarget
    {
      [DispId(32038)]
    ...
    public static DataTable Get_GuiModalWindow_SapElements()
    {
      // Clear any previous element collection.
      ...
      // Call ScanAll to populate the table with grid elements.
