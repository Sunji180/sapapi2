...
namespace SAP_API
{
  public class MyGuiSimpleContainer
  {
    public interface ISapSimpleContainerTarget
    {
      [DispId(32046)]
      int ScreenLeft { get; }
      ...
      [DispId(32063)]
      int LoopColCount { get; }

      [DispId(32064)]
      int LoopRowCount { get; }

      [DispId(32065)]
      int LoopCurrentCol { get; }

      [DispId(32066)]
      int LoopCurrentRow { get; }
