...
namespace SAP_API
{
  public class MyGuiScrollContainer
  {
    public interface ISapScrollContainerTarget
    {
      [DispId(32006)]
      int Height { get; }
      ...
      [DispId(32601)]
      GuiScrollbar VerticalScrollbar { get; set; }

      [DispId(32600)]
      GuiScrollbar HorizontalScrollbar { get; set; }
